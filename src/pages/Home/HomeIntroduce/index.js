                ...
                <div className={cx('row')}>
                    <div className={cx('col-md-4', 'col-sm-12', 'col-xs-12')}>
                        ...
                        <div className={cx('editer')}>
                            <p></p>
                            <p>
                                Công ty TNHH Thẩm định giá iValue là doanh nghiệp đủ điều kiện kinh doanh dịch vụ thẩm
                                định giá theo quy định tại Luật Giá số 11/2012/QH13 và Nghị Định số 89/2013/NĐ-CP ngày
                                06/08/2013 của Chính Phủ quy định chi tiết thi hành một số điều của Luật Giá về thẩm
                                định giá. iValue là công ty chuyên ngành về thẩm định giá, tư vấn đầu tư và tư vấn dự
                                án. iValue đã cung cấp dịch vụ chất lượng cao cho nhiều khách hàng, khẳng định được năng
                                lực, uy tín, thương hiệu trong nước và các đối tác nước ngoài, đáp ứng các chuẩn mực cao
                            ...
                            <div className={cx('col-md-6', 'col-sm-6', 'col-xs-6', 'fwmb')}>
                                <div className={cx('list-gt')}>
                                    ...
                                    <div className={cx('info-gt')}>
                                        ...
                                        <div>
                                            Trở thành doanh nghiệp hàng đầu Việt Nam trong lĩnh vực thẩm định giá và tư
                                            vấn đầu tư.
                                            <br></br>
                                            Xây dựng hình ảnh doanh nghiệp thẩm định giá chuyên nghiệp mang tầm quốc tế,
                                            đóng góp cho sự phát triển lành mạnh, bền vững của nền kinh tế.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className={cx('col-md-6', 'col-sm-6', 'col-xs-6', 'fwmb')}>
                                <div className={cx('list-gt')}>
                                    ...
                                    <div className={cx('info-gt')}>
                                        ...
                                        <div>
                                            Hướng tới xây dựng hình ảnh doanh nghiệp uy tín, cung cấp dịch vụ chất lượng
                                            cao.
                                            <br></br>
                            ...
                            <div className={cx('col-md-6', 'col-sm-6', 'col-xs-6', 'fwmb')}>
                                <div className={cx('list-gt')}>
                                    ...
                                    <div className={cx('info-gt')}>
                                        ...
                                        <div>
                                            Đội ngũ nhân sự có trình độ chuyên môn cao, giàu kinh nghiệm, năng động,
                                            sáng tạo.
                                        </div>
                                    </div>
                                </div>
