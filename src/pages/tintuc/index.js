                            ...
                            <div className={cx('item-news', 'item-normal')}>
                                <div className={cx('item-wrap')}>
                                    <div className={cx('item-thumb')}>
                                        <a href="#">
                                            <img
                                                src="https://img.lovepik.com/background/20211022/medium/lovepik-small-fresh-summer-beach-taobao-cartoon-promotion-background-image_605600456.jpg"
                                        ...
                                        <div className={cx('type-news')}>
                                            <a href="/vi/news/su-kien-noi-bat-c22.html">Tin Tức Nổi Bật</a>
                                        </div>
                                    </div>
