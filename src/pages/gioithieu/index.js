                        ...
                        <div className={cx('col-md-9', 'order-1')}>
                            <div className={cx('introductionContent')}>
                                <div className={cx('center')}>
                                    <img
                                        src={
                                            'https://cdn.tgdd.vn/hoi-dap/1369909/200-anh-lam-slide-powerpoint-cuc-dep-chuyen-nghiep-khong%20(5).jpg'
                                        }
                                    />
                                </div>
                                    ...
                                    <div className={cx('col-md-10')} data-aos="fade-left">
                                        <div className={cx('principalBlock')}>
                                            ...
                                            <ul class={cx('principalList')}>
                                                <li>
                                                    {' '}
                                                    Phong cách phục vụ uy tín - chuyên nghiệp - thân thiện đã góp phần
                                                    xây dựng nên thương hiệu vận chuyển hàng hóa hàng đầu tại Việt Nam
                                                </li>
                                                <li>
                                                    {' '}
