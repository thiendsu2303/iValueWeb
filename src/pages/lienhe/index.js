        ...
        <div>
            ...
            <div className={cx('bodyLienHe')}>
                <div className={cx('container')}>
                    ...
                    <div className={cx('col-md-6', 'left', 'contact')} data-aos="faded-right">
                        <h3 className={cx('bold', 'nomargin', 'text-uppercase')}>THÔNG TIN LIÊN HỆ</h3>
                        <div className="clear20"></div>
                        <div className={cx('ivalueAddress')}>
                            <p>
                                <i class="fas fa-map-marker-alt"></i> L17-11, Tòa nhà Vincom Center, 72 Lê Thánh Tôn,
                    ...
                    <div className={cx('col-md-6', 'right')} data-aos="fade-left">
