            ...
            <div className={cx('container')}>
                ...
                <div className={cx('row', 'list-project')}>
                    <div className={cx('item-project')}>
                        ...
                        <div className={cx('paraProject')}>
                            <p>
                                <strong>Dự án Khách sạn Senla Boutique</strong>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className={cx('row', 'list-project')}>
                    <div className={cx('item-project')}>
                        ...
                        <div className={cx('paraProject')}>
                            <p>
                                <strong>Hệ thống kho chứa LPG - Khu công nghiệp Đình Vũ</strong>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className={cx('row', 'list-project')}>
                    <div className={cx('item-project')}>
                        ...
                        <div className={cx('paraProject')}>
                            <p>
                                <strong>Dự án Tân Cảng Sài Gòn</strong>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className={cx('row', 'list-project')}>
                    <div className={cx('item-project')}>
                        ...
                        <div className={cx('paraProject')}>
                            <p>
                                <strong>Bệnh viện Chợ Rẫy</strong>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className={cx('row', 'list-project-small')}>
                    <div className={cx('item-project')}>
                        ...
                        <div className={cx('paraProject')}>
                            <p>
                                <strong>Dự án Charm Plaza(Dĩ An, Bình Dương)</strong>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className={cx('row', 'list-project-small')}>
                    <div className={cx('item-project')}>
                        ...
                        <div className={cx('paraProject')}>
                            <p>
                                <strong>Làng du lịch Cù Lần</strong>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className={cx('row', 'list-project-small')}>
                    <div className={cx('item-project')}>
                        ...
                        <div className={cx('paraProject')}>
                            <p>
                                <strong>Hệ thống nổi hơi</strong>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className={cx('row', 'list-project-small')}>
                    <div className={cx('item-project')}>
                        ...
                        <div className={cx('paraProject')}>
                            <p>
                                <strong>Vườn cao su tại Bình Phước</strong>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className={cx('row', 'list-project-small')}>
                    <div className={cx('item-project')}>
                        ...
                        <div className={cx('paraProject')}>
                            <p>
                                <strong>Hệ thống máy móc phương tiện vận tải</strong>
                            </p>
                        </div>
                    </div>
                </div>
